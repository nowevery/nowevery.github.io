    ...
    $.fn.extend({
        select: function (options) {
            ...
            var defaults = {
                ...
                rowColor:"#fff",          //行原本的颜色
                rowHoverColor: "#D90000", //移动选择时，每一行的hover底色
            ...
            $This.find(".select_list_body .mCSB_dragger_bar").css({ "background-color": "#000" });

            //传进来的参数操作，需要写在滚动插件调用之后
            if (opts.themeColor.trim() != "" && opts.themeColor.trim() != "#000") {
